            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    ...
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        <div class="rounded-md shadow">
                            <a href="https://github.com/codemenco/laravel-notify" class="flex items-center justify-center w-full px-6 py-3 text-base font-medium leading-5 text-white transition duration-150 ease-in-out bg-pink-600 border border-transparent rounded-md hover:bg-pink-500 focus:outline-none focus:shadow-outline-red md:py-4 md:text-lg md:px-10">
                                Getting Started
                            </a>
                        </div>
                    </div>
                ...
                <div class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
                    ...
                    <div class="mt-32 md:mt-0 relative mx-auto w-full rounded-lg lg:max-w-md">
                        <img class="animate-bounce relative mx-auto" width="490" src="{{ asset('/vendor/codemenco/laravel-notify/images/notifications.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="mt-10 relative lg:mt-0">
                        ...
                        <div class="mt-4">
                            <div class="max-w-sm w-full bg-white shadow-lg rounded-md pointer-events-auto">
                                <div class="h-48 relative rounded-md shadow-xs overflow-hidden">
                                    <img class="absolute inset-0" src="{{ asset('/vendor/codemenco/laravel-notify/images/drake-success.jpg') }}" alt="">
                    ...
                    >
                        ...
                        <div class="mt-4">
                            <div class="max-w-sm w-full bg-white shadow-lg rounded-md pointer-events-auto">
                                <div class="h-48 relative rounded-md shadow-xs overflow-hidden">
                                    <img class="absolute inset-0" src="{{ asset('/vendor/codemenco/laravel-notify/images/drake-error.jpg') }}" alt="">
