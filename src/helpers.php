...
if (! function_exists('notifyJs')) {
    ...
    {
        return '<script type="text/javascript" src="'.asset('vendor/codemenco/laravel-notify/js/notify.js').'"></script>';
    }
}
...
if (! function_exists('notifyCss')) {
    ...
    {
        return '<link rel="stylesheet" type="text/css" href="'.asset('vendor/codemenco/laravel-notify/css/notify.css').'"/>';
    }
}
